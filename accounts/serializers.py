...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','email','first_name','middle_name','last_name','phone_number', 'id_number', 'credit_status', 'is_superuser']
...
class UserDetailSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.front_id_image = validated_data.get("front_id_image", instance.front_id_image)
        instance.back_id_image = validated_data.get("back_id_image", instance.back_id_image)
