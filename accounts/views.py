...
from .serializers import ChangePasswordSerializer, RegisterUserSerializer, SetNewPasswordSerializer, UserDetailSerializer, UserSerializer
...
class UserProfileUpdateAPIView(RetrieveUpdateAPIView):
    ...
    # def put(self, request, *args, **kwargs):
    #     try:
    #         user = self.queryset.get(pk=kwargs["user_id"])
    #         serializer = UserDetailSerializer()
    #         update_user = serializer.update(user, request.data)
    #         return Response(UserDetailSerializer(update_user).data)
